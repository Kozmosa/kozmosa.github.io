...
export const themeConfig: ThemeConfig = {
  ...
  color: {
    ...
    light: {
      ...
      highlight: 'oklch(0.75 0.15 200 / 0.4)',
    },
    dark: {
      // primary color
      primary: 'oklch(90% 0.02 250)',
      // secondary color
      secondary: 'oklch(75% 0.02 250)',
      // background color
      background: 'oklch(20% 0.02 250)',
      // highlight color
      highlight: 'oklch(0.75 0.15 200 / 0.25)',
    },
  },
  // COLOR SETTINGS >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> END
